  ...
  return (
    <div>
      ...
      <div className='mb-3 mr-6	flex flex-row-reverse items-end'>
        <div className='ml-1.5 flex max-w-[13.5rem] flex-col rounded-lg bg-pastelred px-2.5 py-2.5 sm:max-w-[16.5rem]'>
          {pictureUrl !== null && <img src={pictureUrl} alt='Thumbnail' />}
