        ...
        <div className='relative flex h-20 w-full items-center justify-between'>
          {backBtn ? (
            <div className='absolute left-7 z-20 flex items-center justify-center'>
              <IoIosArrowBack className='h-6 w-6 fill-gray' onClick={() => history.back()} />
            </div>
          ) : null}
        ...
        <div className='relative flex h-20 w-full items-center justify-between'>
          {cancelStr ? (
            <div className='absolute left-7 flex items-center justify-center'>
              <div className='font-sans text-xs text-gray' onClick={() => history.back()}>
                취소
              </div>
            </div>
          ) : null}
          {backBtn ? (
            <div className='absolute left-7 flex items-center justify-center'>
              <IoIosArrowBack id='backBtn' className='h-6 w-6 fill-gray' onClick={() => history.back()} />
            </div>
          ) : null}
